  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <div class="container">
          <p class="caption">If you're experiencing any issues, contact us with your issue</p>
          <div class="divider"></div>
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Comment Box</h4>
              </div>
<div>
    ...
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © Ibnul Islam Tilok <a class="grey-text text-lighten-4" href="#" target="_blank">Students</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">IIT</a></span>
        </div>
    </div>
  </footer>
